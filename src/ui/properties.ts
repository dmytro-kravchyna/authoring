...
export class PropertiesPanel {
  ...
  private render() {
    ...
    if (typeKind) {
      ...
      this.container.innerHTML = `<h3>${contract.kind.charAt(0).toUpperCase() + contract.kind.slice(1)} Properties</h3>` +
        '<div style="color:#666;font-size:13px;">No editable properties</div>';
    }
  }
